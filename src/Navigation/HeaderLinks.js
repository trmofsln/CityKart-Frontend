    ...
    <nav className="headerLinks">
      ...
      <div className="header__items">
        ...
        {auth.isLoggedIn && (auth.userMode==="seller")  && (
          <Link to={`/${auth.userId}/addProduct`} className="header__link">
            <div className="header__option">
        ...
        {/* 4th link */}
        {auth.isLoggedIn && (auth.userMode==="seller")  && (
          <Link to={`/${auth.userId}/updateProduct`} className="header__link">
            <div className="header__option">
        ...
        {/* 5th link */}
        {auth.isLoggedIn && (
          <Link to={`/${auth.userId}/checkout`} className="header__link">
            <div className="header__option">
        ...
        {/* 6th link */}
        {auth.isLoggedIn && (
          <Link to={`/${auth.userId}/logout`} className="header__link">
            <div className="header__option">
